...
class About extends Component {
    ...
    render() { 
        return ( 
            ...
            India's population in 2021 as per World Bank is 1.39 billion. Being the world's
...
to create an ecosystem that can be between hospitals, clinics, pharmacies, and patients.
            </p>
            </blockquote>
